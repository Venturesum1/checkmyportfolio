...
export const LimelightNav = ({
  ...
  return (
    <nav className={`relative inline-flex items-center rounded-lg bg-card text-foreground border ${className}`}>
      ...
      <div 
        ...
        // style={{ left: '-999px' }}
              ref={limelightRef}
              className={`absolute top-0 z-10 w-11 h-[5px] rounded-full  bg-blue-500  shadow-[0_50px_15px_rgba(59,130,246,0.7)] ${isReady ? 'transition-[left] duration-400 ease-in-out' : ''} ${limelightClassName || ''}`}
              style={{ left: '-999px' }}
      >
